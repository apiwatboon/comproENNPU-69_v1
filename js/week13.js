/* ============================================================
   week13.js — คาบที่ 14: นำเสนอโปรเจกต์ + ทบทวนปลายภาค
   (เช็คลิสต์ก่อนขึ้นเวที จำค่าใน localStorage,
    ข้อสอบจำลองปลายภาคเน้นคาบ 9–12)
   ============================================================ */
...
// ---------- ข้อสอบจำลองปลายภาค: เน้นคาบ 9–12 + บูรณาการ (ภาษาซี) ----------
window.QUIZ_QUESTIONS = [
  {
    q: '[คาบที่ 9] int area(int w, int h) { return w * h; } — printf("%d", area(3, 4)); แสดงค่าใด?',
    opts: ['7', '12', 'w * h', '0'],
    ans: 1,
  ...
  {
    q: '[คาบที่ 9] ฟังก์ชันคำนวณภาษีประกาศตัวแปร vat ข้างใน — โค้ดใน main เรียก printf ค่า vat ตรง ๆ จะเกิดอะไร?',
  ...
  {
    q: '[คาบที่ 10] int L[4] = {5, 10, 15, 20}; — ค่าของ L[1] และดัชนีของ "ตัวสุดท้าย" คือข้อใด?',
  ...
  {
    q: '[คาบที่ 10] temps มี n ค่า — ค่าเฉลี่ยที่ "ถูกต้อง" เขียนอย่างไร?',
    opts: [
    ...
    ans: 1,
    explain: 'ภาษาซีไม่มีฟังก์ชันเฉลี่ยสำเร็จรูป และ sum / n ที่เป็น int ทั้งคู่จะตัดเศษทิ้ง! ต้องแปลงเป็น (float) ก่อนหาร — กับดักคาบที่ 5 ที่ตามมาหลอกถึงคาบอาร์เรย์'
  },
  {
    q: '[คาบที่ 11] จะเก็บคำว่า "ROBOT" (5 ตัวอักษร) อาร์เรย์ char ต้องมีอย่างน้อยกี่ช่อง เพราะอะไร?',
    opts: [
  ...
  {
    q: '[คาบที่ 11] การตรวจว่าข้อความ user ตรงกับ "admin" หรือไม่ ข้อใดถูกต้อง?',
    opts: [
      'if (user == "admin")',
  ...
  {
    q: '[คาบที่ 12] โปรแกรมบันทึกผล QC ต่อท้ายไฟล์เดิมทุกวัน ควรเปิดไฟล์ด้วยข้อใด?',
    opts: [
      'fopen("qc.txt", "r")',
      'fopen("qc.txt", "w")',
      'fopen("qc.txt", "a")',
  ...
  {
    q: '[คาบที่ 12] หลัง FILE *fp = fopen("data.csv", "r"); บรรทัดถัดไปที่ "ขาดไม่ได้" คือข้อใด?',
    opts: [
      'fclose(fp);',
  ...
  },
  {
    ...
    opts: ['2', '3', '4', '210'],
    ans: 1,
    explain: 'ไล่ทีละตัว: 70 ≥ 60 นับ ✓ · 50 ✗ · 80 ✓ · 60 ≥ 60 นับ ✓ (>= รวมค่าเท่า!) = 3 — ฟังก์ชัน + อาร์เรย์ + ลูป + เงื่อนไข + ตัวสะสม ครบห้าคาบในข้อเดียว แบบฉบับข้อสอบปลายภาค'
  },
  {
