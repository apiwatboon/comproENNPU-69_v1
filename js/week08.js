/* ============================================================
   week08.js — คาบที่ 10: อาร์เรย์ (ภาษาซี)
...
window.QUIZ_QUESTIONS = [
  ...
  },
  {
    ...
    ans: 1,
    explain: 'ขนาดอาร์เรย์ตายตัว จึงประกาศเผื่อแล้วใช้ n นับของจริง — ลูปทุกตัววน i < n เพื่อไม่ไปอ่าน "ค่าขยะ" ในช่องที่ยังไม่ใช้ (8–99) — คู่หู arr + n คือหัวใจของโปรเจกต์คาบที่ 13'
  }
];
